    ...
    <div className="relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm">
          ...
          <img
            src={
              image
                ...
                : user?.image ||
                  "https://images.unsplash.com/photo-1761839258605-d1b118266ccc?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            }
            alt=""
            className="h-9 md:h-15 w-9 md:w-15 rounded-full mx-auto"
          />
      ...
      {image && (
        <button className="absolute top-0 right-0 flex p-2 gap-1 bg-primary/10 text-primary cursor-pointer" onClick={updateImage}> Save
            <img src={assets.save_icon} alt="" width={13} />
        </button>
      )}
