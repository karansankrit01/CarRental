  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title
        ...
        subTitle="Monitor overall platform performance including total cars, booking , revenue and rental activities"
      />
        ...
        {dashBoardCard.map((card, index) => (
          ...
          >
            <div>
              ...
              <p className="text-lg font-semi-bold">{card.value}</p>
            </div>
